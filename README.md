...
Estudiante apasionado por crear soluciones tecnológicas con impacto social. Combino desarrollo de software con experiencia en soporte técnico para construir aplicaciones eficientes y centradas en el usuario.

* 🌍  Dosquebradas, Risaralda, Colombia
* ✉️  [f.martinez5@utp.edu.co](mailto:f.martinez5@utp.edu.co)
* 🤝  Abierto a colaborar en **proyectos de IA, obras sociales y soluciones para microempresas**
* 🧠  Actualmente aprendiendo Machine Learning y arquitecturas avanzadas de software
...
🎓 **Formación Académica:**
- Ingeniería en Sistemas y Computación - 4to semestre
- Tecnología en Desarrollo de Software - 5er semestre

💼 **Experiencia Profesional:**
- Soporte técnico en sitio y atención al cliente
- Gestión y mantenimiento de sistemas informáticos y eléctricos

🎯 **Enfoque Actual:**
- Desarrollo Full Stack con énfasis en tecnologías modernas
- Inteligencia Artificial y Machine Learning
- Proyectos de impacto social y soluciones empresariales

💡 **Filosofía:**
Crear soluciones tecnológicas eficientes que resuelvan problemas reales, combinando código limpio con experiencia de usuario excepcional.
...
<!-- Agrega tus badges de Cisco aquí -->
<p align="left">
<!-- Ejemplo de estructura para tus certificados:
<img src="ruta/a/tu/badge-cisco-python.png" alt="Python Cisco" width="150"/>
<img src="ruta/a/tu/badge-cisco-networking.png" alt="Networking Cisco" width="150"/>
-->
📜 **Python** - Cisco Networking Academy  
📜 **[Otros módulos completados]** - Cisco Networking Academy
</p>

### Otras Certificaciones
- 🔐 **Ciberseguridad** - Platzi
- 💻 Certificaciones adicionales en desarrollo de software

> 💡 **Tip:** Sube tus insignias a la carpeta del repositorio y actualiza las rutas de las imágenes aquí.
...
Portal educativo para gestionar calificaciones, usuarios, asignaturas y reportes.
- **Repositorio:** https://github.com/Craos6518/Proyecto-academico-version-andres
- **Aplicación en producción:** https://proyecto-academico-version-andres-git-main-craos-projects.vercel.app
- **Tecnologías:** Next.js, React, TypeScript, Tailwind CSS, Supabase (PostgreSQL, Auth, API REST)
- **Funciones clave:** control de acceso por roles, validaciones de rango de notas, cálculo automático de nota final, historial y auditoría
- **Entorno:** desarrollo asistido en v0.app con despliegue en Vercel

### To-Do List Project
Aplicación web responsive para crear, editar y organizar tareas con categorías y estados.
- **Tecnologías:** HTML, CSS, JavaScript
- **Funciones clave:** gestión de tareas, categorías (máx. 10), prioridades, estados (comenzada, culminada, aplazada)
- **Estructura:** páginas separadas para categorías, prioridades y estado; barra de navegación

### Calculadora Gráfica en C
Calculadora capaz de graficar polinomios y gestionar cuentas desde consola con archivos de texto.
- **Tecnologías:** C (librerías `conio.h` y `graphics.h`)
- **Funciones clave:** graficado de polinomios de cualquier grado y escalado de gráficos
- **Notas técnicas:** compatible con compiladores de 32 bits; no soporta divisiones, logaritmos ni raíces

### Sistema de Gestión de Inventario
Aplicación web para registrar productos, controlar stock y generar reportes.
- **Stack:** Frontend (HTML, CSS, JavaScript) y Backend (Node.js + Express + MySQL)
- **Funciones clave:** registro de productos, monitoreo de stock, reportes y autenticación con JWT
- **Estructura:** /frontend, /backend, /database y /tests
...
- Gestión de infraestructura eléctrica y de redes
- Documentación técnica y capacitación a usuarios

**Habilidades Desarrolladas:**
- Resolución de problemas bajo presión
- Comunicación efectiva con usuarios no técnicos
- Diagnóstico rápido y eficiente de fallas
- Trabajo en equipo y gestión de tiempo
...
<a href="https://github.com/Craos6518"><img src="https://github-readme-stats.vercel.app/api/top-langs/?username=Craos6518&langs_count=10&title_color=f97316&text_color=ffffff&icon_color=0891b2&bg_color=1c1917&hide_border=true&locale=en&custom_title=Top%20%Languages" alt="Top Languages" /></a>
...
- Soluciones tecnológicas para ONG
...
**¿Tienes una idea? ¡Hablemos!** Envíame un correo a [f.martinez5@utp.edu.co](mailto:f.martinez5@utp.edu.co)
...
<p align="left">
<a href="https://www.github.com/Craos6518" target="_blank" rel="noreferrer">
<picture>
...
<a href="https://www.facebook.com/andresfelipe.martinezhenao" target="_blank" rel="noreferrer">
<picture>
...
<a href="http://www.instagram.com/craos_6518/" target="_blank" rel="noreferrer">
<picture>
...
<a href="https://www.twitch.tv/craos6518" target="_blank" rel="noreferrer">
<picture>
...
<p align="center">
  <i>⚡ "El código limpio no es escrito siguiendo reglas, es escrito por programadores que se preocupan por el arte." - Robert C. Martin</i>
</p>

<p align="center">
  <img src="https://komarev.com/ghpvc/?username=Craos6518&color=f97316&style=flat-square&label=Profile+Views" alt="Profile views" />
</p>
